...
"""
Awake-image → sleep transfer-learning benchmark  
 • Trains a LASSO-regularised GLM on every single time point (80) of awake-image EEG.  
...
def train(params_):
    ...
    for index_number in index_numbers:
        ...
        data_save_path = os.path.join(resultpath, "lasso_awakeimage2sleep_temporal.pickle")
