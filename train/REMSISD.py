...
if __name__ == "__main__":
    ...
    datapath   = os.path.join(basepath, 'data', 'Sleep Decoding', 'train_pickle', 'REM')
    ...
    # -------------------- Dataset --------------------
    pickle_files = sorted(os.path.join(datapath, f) for f in os.listdir(datapath) if f.startswith('single_REM'))
