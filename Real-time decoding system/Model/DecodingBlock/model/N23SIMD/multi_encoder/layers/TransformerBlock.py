...
if __name__ == "__main__":
    ...
    from Model.DecodingBlock.model.N23SIMD.multi_encoder.layers import MultiHeadAttention
    from Model.DecodingBlock.model.N23SIMD.multi_encoder.layers import FeedForward
