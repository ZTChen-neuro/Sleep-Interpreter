...
# ---------------------------------------------------------------------------
# Zero-shot evaluation of SISD model on REM sleep-EEG data
#
# Workflow
...
if __name__ == "__main__":
    ...
    model_item       = SISD()
    checkpoint_path  = os.path.join(checkpath, "REM_SISD.ckpt")
    ...
    save_path = os.path.join(basepath, 'results', 'REMSISD_Decode_Result.pickle')
