...
"""
REM → awake transfer-learning benchmark  
 • Trains a LASSO-regularised GLM on every single time point (200) of REM sleep EEG.  
...
def train(params_):
    ...
    for index_number in index_numbers:
        ...
        data_save_path = os.path.join(resultpath, "lasso_REM2awake_temporal.pickle")
